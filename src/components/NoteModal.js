...
export const NewNoteModal = () => {
    ...
    return <div>
        ...
        <NoteModal note={null} handleFormSubmit={NewNote} show={show} handleClose={handleClose}></NoteModal>
    </div>
}
...
export const EditNoteModal = ({ note }) => {
    ...
    return <div>
        ...
        <NoteModal note={note} handleFormSubmit={EditNote} show={show} handleClose={handleClose}></NoteModal>
    </div>
}
    ...
    return (
        <Modal show={show} onHide={handleClose}>
            ...
            <Form onSubmit={event => {
                ...
                <Modal.Body>
                    <InputGroup>
                        <FormControl value={modalNote === null ? '' : modalNote.value} onChange={event => setModalNote({ ...modalNote, value: event.target.value })}></FormControl>
                    </InputGroup>
                </Modal.Body>
                <Modal.Footer>
